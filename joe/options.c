...
struct glopts {
	...
	{"left", 1, &opt_left, NULL, _("Columns to scroll left or -1 for 1/2 window (%d): "), 0, _("  Left scroll columns "), 0, -1, 64 },
	{"right", 1, &opt_right, NULL, _("Columns to scroll right or -1 for 1/2 window (%d): "), 0, _("  Right scroll columns "), 0, -1, 64 },
