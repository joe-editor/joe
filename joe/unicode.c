...
/* Zero width characters.  Markus Kuhn says:
 *
 ...
 */
	cclass_init(cclass_zero);
	cclass_union(cclass_zero, unicode("Me"));
	cclass_union(cclass_zero, unicode("Mn"));
	cclass_union(cclass_zero, unicode("Cf"));
	cclass_sub(cclass_zero, 0xad, 0xad);
	cclass_add(cclass_zero, 0x1160, 0x11FF);
	cclass_add(cclass_zero, 0x200b, 0x200b);
 ...
 */
	...
	cclass_add(cclass_double, 0x1100, 0x115F); /* Hangul Jamo init. consonants */
	cclass_add(cclass_double, 0x2329, 0x2329);
	cclass_add(cclass_double, 0x232a, 0x232a);
	cclass_add(cclass_double, 0x2e80, 0x303e);
	/* 0x303F is: Ideographic half-width */
	cclass_add(cclass_double, 0x3040, 0xa4cf);
	cclass_add(cclass_double, 0xac00, 0xd7a3); /* Hangul Syllables */
	cclass_add(cclass_double, 0xf900, 0xfaff); /* CJK Compatibility Ideographs */
	cclass_add(cclass_double, 0xfe10, 0xfe19); /* Vertical forms */
	cclass_add(cclass_double, 0xfe30, 0xfe6f); /* CJK Compatibility forms */
	cclass_add(cclass_double, 0xff00, 0xff60); /* Fullwidth Forms */
	cclass_add(cclass_double, 0xffe0, 0xffe6);
	cclass_add(cclass_double, 0x20000, 0x2fffd);
	cclass_add(cclass_double, 0x30000, 0x3fffd);
...
int joe_wcwidth(int wide,int ucs)
{
	...
	if (cclass_lookup(cclass_zero, ucs))
		return 0;
