...
\[\\w\\d\] are in cclass.c and cclass.h.  These are used by the syntax
...
intervals, see unicat.c.  Unicat.c is generated by util/uniproc.c from the
raw data provided on the unicode.org website.  Arrays of intervals provide
...
so that leaf nodes can be optimized.
